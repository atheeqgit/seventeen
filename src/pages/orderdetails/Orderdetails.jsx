      ...
      <div className="flex flex-col md:grid md:grid-cols-12 gap-3 ">
        ...
        <div className="md:col-span-6 border  border-solid border-[#2459E0] rounded-lg p-8 flex flex-col gap-5 w-full">
          <div className="flex flex-row justify-between ">
            <h1 className="text-4xl capitalize font-semibold text-[#4E5562]">
              order status :
            </h1>
            <p className="text-3xl capitalize font-semibold">ON GOING</p>
          </div>
          <div className="flex flex-row justify-between ">
            <h1 className="text-4xl capitalize font-semibold text-[#4E5562]">
              Order ID :
            </h1>
            <p className="text-3xl capitalize font-semibold">202459862A</p>
          </div>
          <div className="flex flex-row justify-between ">
            <h1 className="text-4xl capitalize font-semibold text-[#4E5562]">
              Date :
            </h1>
            <p className="text-3xl capitalize font-semibold">15-JUNE-2024</p>
          </div>
          <div className="flex flex-row justify-between ">
            <h1 className="text-4xl capitalize font-semibold text-[#4E5562]">
              payment method :
            </h1>
            <p className="text-3xl capitalize font-semibold">online</p>
          </div>
          <hr className="my-4" />
          <div className="flex flex-row justify-between ">
            <h1 className="text-4xl capitalize font-semibold text-[#4E5562]">
        ...
        <div className="md:col-span-12 border  border-solid border-[#2459E0] rounded-lg p-8 flex flex-row gap-4 justify-between w-full">
          <h1 className="text-4xl uppercase font-semibold text-[#4E5562]">
            GRAND TOTAL:
          </h1>
          <p className="text-5xl capitalize font-semibold">399</p>
        </div>
      </div>
    </div>
  );
